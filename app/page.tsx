    ...
    <main className="min-h-screen bg-zinc-50 text-zinc-900 selection:bg-orange-200 overflow-x-hidden font-sans">
      ...
      <section id="about" className="py-32 px-6 bg-white/40 relative z-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-5xl font-black uppercase italic leading-tight mb-6">Minal's Most <span className="text-orange-600 underline">Loaded</span> Spot</h2>
            <p className="text-zinc-600 text-lg mb-10">Pizza Brothers is famous for loaded cheese pizzas and juicy burgers in Minal Residency, Bhopal.</p>
            <GlassCard className="p-8 flex justify-around border-none bg-orange-50/50">
              <div className="text-center"><p className="text-3xl font-black text-orange-600">4.4 ⭐</p><p className="text-[10px] font-black text-zinc-400">Rating</p></div>
              <div className="text-center"><p className="text-3xl font-black text-orange-600">110+</p><p className="text-[10px] font-black text-zinc-400">Reviews</p></div>
            </GlassCard>
          </div>
      ...
      <section id="location" className="py-32 px-6 relative z-10">
        <GlassCard className="max-w-6xl mx-auto overflow-hidden border-none group relative">
          <div onClick={() => setShowMapModal(true)} className="absolute inset-0 z-10 cursor-pointer group-hover:bg-black/20 transition-all flex items-center justify-center">
            <Search className="text-white opacity-0 group-hover:opacity-100 scale-50 group-hover:scale-100 transition-all" size={40} />
          </div>
          <div className="grid md:grid-cols-2">
            <div className="p-12 md:p-20">
              <h3 className="text-4xl font-black uppercase italic mb-8">Find Us</h3>
              <div className="space-y-6">
                <div className="flex items-center gap-6"><MapPin className="text-orange-600" /><p className="font-bold">Minal Residency, Sector E, Bhopal</p></div>
                <div className="flex items-center gap-6"><Phone className="text-orange-600" /><p className="font-bold">+91 98765 43210</p></div>
              </div>
            </div>
